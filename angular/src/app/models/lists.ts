...
export const nationalities: Nationality[] = [
    ...
    {value: 'AFG', viewValue: 'Afghanistan'},
    {value: 'ALB', viewValue: 'Albania'},
    {value: 'ALG', viewValue: 'Algeria'},
    {value: 'ASA', viewValue: 'American Samoa'},
    {value: 'AND', viewValue: 'Andorra'},
    {value: 'ANG', viewValue: 'Angola'},
    {value: 'ANT', viewValue: 'Antigua and Barbuda'},
    {value: 'ARG', viewValue: 'Argentina'},
    {value: 'ARM', viewValue: 'Armenia'},
    {value: 'ARU', viewValue: 'Aruba'},
    {value: 'AUS', viewValue: 'Australia'},
    {value: 'AUT', viewValue: 'Austria'},
    {value: 'AZE', viewValue: 'Azerbaijan'},
    {value: 'BAH', viewValue: 'Bahamas'},
    {value: 'BAR', viewValue: 'Barbados'},
    {value: 'BRN', viewValue: 'Bahrain'},
    ...
    {value: 'PHI', viewValue: 'Philippines'},
    {value: 'POL', viewValue: 'Poland'},
    {value: 'POR', viewValue: 'Portugal'},
    {value: 'PUR', viewValue: 'Puerto Rico'},
    ...
    {value: 'KOR', viewValue: 'South Korea'},
    {value: "SWE", viewValue: 'Sweden'},
    {value: 'SUI', viewValue: 'Switzerland'},
    {value: 'TPE', viewValue: 'Taiwan'},
    {value: 'THA', viewValue: 'Thaïland'},
...
dic_of_routines['national_team_all']="all national team seasons creation";
...
dic_of_display['national_team_all']="year_begin";
